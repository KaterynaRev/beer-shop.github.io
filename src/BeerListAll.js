                    ...
                    <div className="beerList">
                        {currentBeers.length > 0 ? (
                            currentBeers.map((beer) => (
                                <div key={beer.id} className="beerItem" onClick={(e) => {handleBeerClick(beer.id, e)}}>
                                    <img className="imgBeerAll" src={beer.image_url} alt={beer.name}/>
                                    <h3 className="nameBeerh3">{beer.name}</h3>
                                    <p className="priceBeerP"><strong>{beer.price}</strong></p>
                                </div>
                            ))
                        ) : (
                            <p>No beers found.</p>
